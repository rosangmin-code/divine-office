...
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 251 (pdftotext)

### PSALTER/w2/SAT/vespers (page 172)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 172 (pdftotext)

### PSALTER/w3/THU/vespers (page 371)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 371 (pdftotext)

### PSALTER/w4/MON/vespers (page 437)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 437 (pdftotext)

### PSALTER/w4/FRI/lauds (page 497)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 497 (pdftotext)

### PSALTER/w4/FRI/vespers (page 504)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 504 (pdftotext)

### PSALTER/w4/SAT/lauds (page 518)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 518 (pdftotext)

### PSALTER/w4/SAT/vespers (page 404)
- reason: exception
- error: [rich-builder] section heading /^[Уу]ншлага(?:[\s\t]|$)/u not found in book 404 (pdftotext)

...
let _psalterTexts: Record<string, { stanzas: string[][]; psalmPrayer?: string; psalmPrayerPage?: number }> | null = null

function loadPsalterTexts(): Record<string, { stanzas: string[][]; psalmPrayer?: string; psalmPrayerPage?: number }> {

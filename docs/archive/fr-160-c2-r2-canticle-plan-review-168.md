...
- 대상 문서: `docs/archive/fr-160-c2-r2-canticle-plan.md` (329 lines, base_commit 47e5bf6 의 a2eeadb)
- 의존 자료 (read-only 검증 시 참조) :
  - `docs/archive/fr-160-c2-gap-audit.md` (Cat A 23 entries)
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:179`
- 결함:
  ```js
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:228`
- 결함:
  ```js
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:158-164` (§5 매핑 테이블)
- 결함:
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:189-195` (§6.2 NT_CANTICLE_BOOKS)
- 결함:
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:137,256`
- 결함:
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:217-224`
- 결함:
  ```js
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:84,323`
- 결함:
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:248,310`
- 결함:
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:295,299`
- 결함:
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:158-162`
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:322-327`
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:297`
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:99` (의사코드 `page=pageOfLine[i]`)
...
- 위치: `docs/archive/fr-160-c2-r2-canticle-plan.md:293`

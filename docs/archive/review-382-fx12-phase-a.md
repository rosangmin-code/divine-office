...
- **현재**: `/залбирцгаая[:.]?\s*$/`
- **Audit 권고** (`docs/archive/handoff-fx12-intercession-italic-audit-2026-05-08.md:164`): `/залбирцгаая[:\.]\s*$/u` (with `u` flag)
...
- **Audit doc**: `docs/archive/handoff-fx12-intercession-italic-audit-2026-05-08.md` (Phase A 권고 §6, 33 anchor sweep §3.1)
- **Combined audit**: `docs/archive/handoff-fx10-fx11-fx12-audit-2026-05-08.md` §3.5 (narrow scope rationale)

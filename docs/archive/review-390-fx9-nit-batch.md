...
- **Audit**: `docs/archive/handoff-fx9-psalm-title-repeat-audit-2026-05-08.md` (F-X9 audit)
...
- **Related reviews**: `docs/archive/review-376-fx9-fix-cohort.md` (NIT origin), `docs/archive/review-389-fx10-fix.md` (preceding review)

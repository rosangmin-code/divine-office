...
Subject finding: docs/archive/review-280-279-fx3-phase-b-30hymn.md F1 MAJOR
Prior spike: docs/archive/handoff-fx3-r2-a1-spike.md (#264 — method a1 LOW feasibility)
Related: docs/archive/review-257-249-fx3-phase-a-pilot.md (#257 R2 권고), docs/archive/handoff-fx3-phrase-audit.md (#228 audit)
...
`docs/archive/handoff-fx3-r2-a1-spike.md` §3.3-3.5 — 11 sample hymn pages 전수에서 WRAP_DELTA=+3 visual-indent signal 부재 (85-90% lines at ind=0). pdftotext-layout 이 hymn region 의 hard-break-only 본문에서 logical phrase 추출 불가 → F1 ≈ 0.10-0.20 (LOW). 즉 PDF 측 신호로 자동 분해는 불가. **method-b 는 PDF 신호 없이 데이터/heuristic 만으로 분해를 시도**.
...
### Prior docs
- `docs/archive/review-280-279-fx3-phase-b-30hymn.md` — #280 review F1 발견
- `docs/archive/handoff-fx3-r2-a1-spike.md` — #264 R2 spike (LOW feasibility, recommend C a2-only)
- `docs/archive/review-257-249-fx3-phase-a-pilot.md` — #257 Phase A 1차 review (R2 권고)
- `docs/archive/handoff-fx3-phrase-audit.md` — #228 audit (P1-A 권고)

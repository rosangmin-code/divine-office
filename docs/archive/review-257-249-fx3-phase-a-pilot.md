...
| Audit reference | `docs/archive/handoff-fx3-phrase-audit.md` (#228, P1-A 권고) |
...
- **의미**: Phase B (~30 hymn week 1 + 나머지 92) 의 ~91% 는 method (a2) 가 phrase 단위 boundary 를 detect 하지 못해 stanza 당 1 phrase 로 fallback. audit `docs/archive/handoff-fx3-phrase-audit.md` §6.2 이 page 933 hymn 76 sample 에서 **stanza 당 2 phrases (logical phrase boundary 기준)** 를 기대한 것에 비하면 sub-optimal.

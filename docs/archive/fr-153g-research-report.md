...
- 본 조사는 `docs/archive/stage6-followup.md §2 🔴 FR-153g` 와 `docs/PRD.md §12.1` 의 상위 계획을 분해한다.
...
**예상 공수**: R1~R4 집중 1 일 + R5 수동 대조 1 일 + R6 자동화 + 검증 1~2 일 = **3~4 일** (당초 docs/archive/stage6-followup.md §2 추정 3~5 일 부합).

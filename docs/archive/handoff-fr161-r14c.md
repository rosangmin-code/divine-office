...
- The Cat-G note about Psalm 144 in `docs/archive/fr-161-r14-pdf-indent-inconsistency.md` §3 is technically accurate at the line-number level but not actionable as a page-mapping fix per the existing book convention encoded in `verify-psalter-pages.js`.

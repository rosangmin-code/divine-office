...
- `docs/archive/handoff-fr161.md` — 누적 FR-161 + FR-easter + Compline sweep 컨텍스트 (포괄적)
- `docs/archive/handoff-compline-c4-audit.md` — C-4 audit doc (181 lines, divine-researcher #wi-003 산출). F-1/F-2 finding 출처
- `docs/archive/handoff-fr-easter-regression.md` — FR-easter audit + Compline Marian root cause + Priority C 권고
- `docs/archive/handoff-fr161-r14c.md` — R-14c page-mapping audit findings

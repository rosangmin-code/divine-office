...
| AC-4 | semantic | MET | MET | MET | Errata states 946 / +9 with breakdown 7 + 2 at `docs/archive/review-331-nit-batch-330.md:120-127`; the test file diff this commit (+4/-2) is fixture-text only, not count-changing. Math reconciles with `npm test` actual = 946. |

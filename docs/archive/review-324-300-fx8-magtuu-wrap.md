...
|----|----------|----------|-----------|-------------|
| **F-1** | minor | doc | `docs/archive/handoff-fx8-magtuu-wrap-rule.md:135-146` | Handoff §5 omits F-X7c (41/45/111) and F-X7b review-318 follow-up F-1/F-2/F-3 orthogonality assessment. They are about a different script and pre-existing structural issues, but their absence weakens traceability. (drives AC-5 PARTIALLY_MET) |
...
1. **F-1 (MINOR — handoff §5 traceability addendum)** — Add 1-2 sentence
   note to `docs/archive/handoff-fx8-magtuu-wrap-rule.md` §5 explicitly stating

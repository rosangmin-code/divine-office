...
Review ref: docs/archive/review-257-249-fx3-phase-a-pilot.md (R2 finding HIGH)
Audit ref: docs/archive/handoff-fx3-phrase-audit.md (#228 P1-A 권고)
...
- `docs/archive/handoff-fx3-phrase-audit.md` (#228) — audit P1-A 권고 (recommend a1/a2/a3 evaluation)
- `docs/archive/review-257-249-fx3-phase-a-pilot.md` — review #257 R2 finding (HIGH) requesting this spike

...
| ID | 요구사항 | 상태 |
|----|----------|------|
| FR-010 | 아침기도(Lauds) 조립: 초대송(`isFirstHourOfDay`일 때), 도입 versicle(Удиртгал), 찬미가, 시편 3개, 짧은 독서, 화답, 복음찬가(Benedictus)+교송, 중보기도, 주님의 기도, 마침기도, 파견. Удиртгал은 항상 포함되며 초대송 바로 다음(또는 초대송이 없으면 첫 번째)에 위치한다. | 완료 |

...
| ~~**2027-12-25(토요일 성탄) 카드 목록이 저녁기도 카드를 제거**~~ **✅ 2026-09-17 FR-175 수정** | `keepsSundayEveningPrayerII` 가 대림·사순·부활 **주일**만 보호해서, 토요일에 떨어진 대축일은 보호되지 않았다. 본문은 성탄 제2저녁기도를 지키지만 카드는 12-26 `firstVespers` 로 유도 → 카드 쪽이 틀렸다. `keepsOwnEveningPrayerII` 로 일반화해 "비주일 대축일 vs 내일 주님의 축일" 규칙을 추가(2027·2032·2038-12-25). |

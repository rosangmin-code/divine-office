...
- **AC**:
  ...
  4. `docs/fr-156-phase5-firstvespers-bare-ref-plan.md` §4 갱신: WI-A4 신설 (verifier 3종 normalize 패치, WI-B1 흡수) + WI-B1..B5 의 task ID/commit 추가. §7 갱신: Open Question Q2 (parser regex bare-ref 지원) 결정 명문화 — Phase 5 에서는 **무수정** (verifier-gated 데이터 normalization 으로 충분) 으로 ADR-style 기록
...
- **target_files**: `docs/PRD.md`, `docs/traceability-matrix.md`, `docs/fr-156-phase5-firstvespers-bare-ref-plan.md`
